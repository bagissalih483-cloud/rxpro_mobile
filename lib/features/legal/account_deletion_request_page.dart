...
import 'account_deletion_request_controller.dart';
...
class _AccountDeletionRequestPageState
  ...
  final AccountDeletionRequestController _controller =
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Hesap silme talebiniz alındı. Destek ekibi inceleyecek.',
          ),
        ),
      );
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
              ...
              CheckboxListTile(
                value: _controller.confirmed,
                onChanged: _controller.submitting
                    ? null
                    : (value) => _controller.setConfirmed(value ?? false),
                title: const Text(
