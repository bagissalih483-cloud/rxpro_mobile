...
class _NotificationPreferencesPageState
  ...
  final NotificationPreferencesController _controller =
  ...
  Future<void> _save(NotificationPreferences next, String key) async {
    _controller.setSavingKey(key);
    try {
              ...
              return ListView(
                ...
                children: [
                  ...
                  _PreferenceCard(
                    ...
                    saving: _controller.savingKey == 'pushEnabled',
                  ...
                  _PreferenceCard(
                    ...
                    subtitle:
                        'Yaklaşan randevu, erteleme ve iptal uyarıları.',
                    icon: Icons.event_available_outlined,
                    value: preferences.pushEnabled &&
                        preferences.appointmentReminders,
                    enabled: preferences.pushEnabled,
                    saving: _controller.savingKey == 'appointmentReminders',
                    onChanged: (value) => _save(
                  ...
                  _PreferenceCard(
                    ...
                    subtitle:
                        'İşletme veya müşteri mesajları için uyarılar.',
                    icon: Icons.mark_chat_unread_outlined,
                    value: preferences.pushEnabled && preferences.messages,
                    enabled: preferences.pushEnabled,
                    saving: _controller.savingKey == 'messages',
                    onChanged: (value) => _save(
                  ...
                  _PreferenceCard(
                    ...
                    enabled: preferences.pushEnabled,
                    saving: _controller.savingKey == 'campaigns',
                    onChanged: (value) => _save(
                  ...
                  _PreferenceCard(
                    ...
                    subtitle:
                        'Güvenlik, hesap ve önemli uygulama uyarıları.',
                    icon: Icons.verified_user_outlined,
                    value: preferences.pushEnabled && preferences.system,
                    enabled: preferences.pushEnabled,
                    saving: _controller.savingKey == 'system',
                    onChanged: (value) => _save(
